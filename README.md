...
- MCP 支持：新增 MCP 服务，AI 客户端可直接管理实例、执行自动化脚本和查看代理池
...
- MCP 服务：支持 Claude Code、Claude Desktop、Cursor 等 AI 客户端通过标准协议管理实例、执行脚本和查看代理池，详见 [docs/mcp-server.md](docs/mcp-server.md)
