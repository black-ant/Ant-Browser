...
1. ZwBrowser 和 OpenClaw 在同一台机器上
2. ZwBrowser 的 LaunchServer 可访问，默认是 \`http://127.0.0.1:19876\`
3. OpenClaw 已安装 \`ant-chrome-openclaw\` skill，并且已有指向 ZwBrowser 的远程 CDP 浏览器配置
...
如果 ZwBrowser 开了 API Key，安装时补上对应参数即可。
