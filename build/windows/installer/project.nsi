...
####
!define REQUEST_EXECUTION_LEVEL "user"               # 每用户安装,免管理员;安装目录可写(Windows 非 detached,app 在安装目录下写 data/、chrome/)
####
...
InstallDir "$LOCALAPPDATA\Programs\${INFO_PRODUCTNAME}" # 每用户可写目录:Windows 非 detached,app 在安装目录下写 data/、chrome/、config.yaml
